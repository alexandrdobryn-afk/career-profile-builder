...
export const dict = {
  ru: {
    ...
    public: {
      ...
      info: 'Информация',
      portfolio: 'Портфолио',
      showAllProjects: 'Посмотреть все',
      collapseProjects: 'Свернуть',
      showAllSkills: 'Показать все',
      collapseSkills: 'Свернуть',
    ...
    dashboard: {
      ...
      project: {
        ...
        deleteLink: 'Удалить ссылку',
        attachment: 'Скриншоты или PDF для онлайн-просмотра',
        chooseFile: 'Выбрать файлы',
        fileHint: 'До 5 файлов: PNG, JPG, WEBP, PDF до 10 МБ каждый',
        add: 'Добавить проект',
      },
      certificate: {
  ...
  uk: {
    ...
    public: {
      ...
      info: 'Інформація',
      portfolio: 'Портфоліо',
      showAllProjects: 'Переглянути всі',
      collapseProjects: 'Згорнути',
      showAllSkills: 'Показати всі',
      collapseSkills: 'Згорнути',
    ...
    dashboard: {
      ...
      project: {
        ...
        deleteLink: 'Видалити посилання',
        attachment: 'Скриншоти або PDF для онлайн-перегляду',
        chooseFile: 'Вибрати файли',
        fileHint: 'До 5 файлів: PNG, JPG, WEBP, PDF до 10 МБ кожен',
        add: 'Додати проєкт',
      },
      certificate: {
  ...
  en: {
    ...
    dashboard: {
      ...
      project: {
        ...
        deleteLink: 'Delete link',
        attachment: 'Screenshots or PDF for online viewing',
        chooseFile: 'Choose files',
        fileHint: 'Up to 5 files: PNG, JPG, WEBP, PDF up to 10 MB each',
        add: 'Add project',
      },
      certificate: {
